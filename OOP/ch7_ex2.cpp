/*
Create a class called employee that contains a name (an object of class string) an employee nubmer (type long).
Include a member  function called getdata() to get data from the user for insertion into the object. and another
